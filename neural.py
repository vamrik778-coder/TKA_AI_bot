...
async def get_neural_response(subject: str, task: str) -> str:
    ...
    subject_prompts = {
        ...
        "русский язык": base_prompt + "Ты учитель русского языка. Твоя задача — помогать с русским языком: объяснять правила орфографии, пунктуации, грамматики, делать разбор слов и предложений, находить определения и т.д. Отвечай на вопросы по русскому языку подробно и понятно.",
